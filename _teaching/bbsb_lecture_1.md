...
|<img src="https://github.com/OlgaVT/OlgaVT.github.io/blob/master/images/hic.jpg" width="25000">|**Hi-C** - an experimental technique to analyze the DNA organization. The logic is similar but we link not DNA and proteins but parts of DNA that are close to each other</ul>|[Hi-C](https://www.youtube.com/watch?v=p1VoktH-ygc) [Computational analysis of Hi-C [paper]](https://pubmed.ncbi.nlm.nih.gov/25448293/)|
