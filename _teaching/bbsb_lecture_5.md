...
| <img src="https://github.com/OlgaVT/OlgaVT.github.io/blob/master/images/BBSB-5_page-0055.png" width="25000">|<ul>**LogFoldChange (LogFC, LFC)** is a logarithm of the ration between normalized gene expression levels between compared groups. Differential analysis tools performs the hypothesis testing to assess the significance of LFC. The null hypothesis is that **there is not differential expression between two groups (LFC=0)**||
